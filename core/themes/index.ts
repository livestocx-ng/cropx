...
export const theme = createTheme({
  ...
  other: {
    ...
    sectionPy: 'clamp(4rem, 8vw, 6.5rem)',
    scrimBottom:
      'linear-gradient(to top, rgba(10, 31, 18, 0.92) 0%, rgba(10, 31, 18, 0.65) 35%, rgba(10, 31, 18, 0.15) 70%, rgba(10, 31, 18, 0) 100%)',
    scrimFull: 'linear-gradient(to top, rgba(10, 31, 18, 0.88) 0%, rgba(10, 31, 18, 0.55) 100%)',
    scrimSide:
      'linear-gradient(to right, rgba(10, 31, 18, 0.9) 0%, rgba(10, 31, 18, 0.6) 45%, rgba(10, 31, 18, 0.1) 100%)',
  },
  colors: {
    primary: [
      '#e8f5ee',
